...
$$
\boxed{\hat{\boldsymbol{\beta}} = \arg\min_{\boldsymbol{\beta}} \left\{\sum_{t \in \text{IS}} \left(R^{\text{fut}}_{i,t+k} - \boldsymbol{\beta}^\top \mathbf{x}_{i,t}\right)^2 + \lambda_1 \|\boldsymbol{\beta}\|_1 + \lambda_2 \|\boldsymbol{\beta}\|_2^2\right\}}
$$
